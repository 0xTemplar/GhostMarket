...
export const AGENT_DEFINITIONS: AgentDefinition[] = [
  {
    ...
    source: 'Binance',
    personality:
      'Data-driven analyst who only trusts on-chain data and top-tier CEX feeds.',
  },
  {
    id: 2,
    name: 'Specter',
    source: 'CoinGecko',
    personality:
      'Cautious risk assessor who requires high-confidence signals before voting YES.',
  },
  {
    id: 3,
    name: 'Wraith',
    source: 'Chainlink',
    personality:
      'Fast mover who prioritises on-chain oracle feeds over off-chain price data.',
  },
  {
    id: 4,
    name: 'Phantom',
    source: 'Coinbase',
    personality:
      'Contrarian thinker who stress-tests the consensus and probes edge cases.',
  },
  {
    id: 5,
    name: 'Shade',
    source: 'Kraken',
    personality:
      'Consensus-seeker who cross-references multiple signals before attesting.',
  },
  {
    id: 6,
    name: 'Echo',
    source: 'OKX',
    personality:
      'Aggregator who synthesises data across sources and weights by volume.',
  },
  {
    id: 7,
    name: 'Vex',
    source: 'Bybit',
    personality:
      'Adversarial tester who actively looks for manipulation or stale data.',
  },
];
